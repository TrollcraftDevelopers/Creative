...
public class ManageTrustedOption implements PlotOption {

    private UUID uuid;

    public ManageTrustedOption(UUID uuid) {
        this.uuid = uuid;
    }
    ...
    public List<String> getLore() {
        ...
        lore.add(Colors.color("&elisty zaufanych tej dzialki."));
        return lore;
    }

    @Override
    public ClickResponse click(Plot plot) {
        plot.getTrusted().remove(uuid);
