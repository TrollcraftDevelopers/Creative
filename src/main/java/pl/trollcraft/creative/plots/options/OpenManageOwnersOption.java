...
public class OpenManageOwnersOption implements PlotOption {

    private PlotPage previous;
    private Player player;

    public OpenManageOwnersOption (PlotPage previous, Player player) {
    ...
    public String getName() {
        return Colors.color("&2&lWlasciciele");
    }
    ...
    public List<String> getLore() {
        ...
        lore.add(Colors.color("&awlascicieli tej dzialki"));
        return lore;
    }

    @Override
    public ClickResponse click(Plot plot) {
        PlotPagesManager.getOwnersPage(plot, previous).open(player);
